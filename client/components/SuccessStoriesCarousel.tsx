  ...
  const caseStudies: CaseStudy[] = [
    {
      ...
      solution:
        "Comprehensive digital marketing strategy with optimized funnels",
      results: [
        "400% increase in qualified leads",
        "250% boost in conversion rates",
        "180% growth in monthly revenue",
      ],
      logo: "🚀",
      rating: 5,
      testimonial:
        "Instantlly transformed our entire digital presence. Their strategic approach delivered results beyond our wildest expectations.",
      author: "Sarah Chen",
    ...
    },
    {
      ...
      results: [
        "$2M in first-quarter sales",
        "85% brand awareness increase",
        "500K+ social media impressions",
      ],
      logo: "🌱",
      rating: 5,
      testimonial:
        "From zero to market leader in just 6 months. Their creativity and execution excellence is unmatched in the industry.",
    ...
    },
    {
      ...
      rating: 5,
      testimonial:
        "Their pan-India expertise helped us scale faster than we ever imagined. True growth partners in every sense.",
      author: "Priya Sharma",
    ...
    },
    {
      ...
      results: [
        "1M+ platform registrations",
        "95% patient satisfaction",
        "400% increase in consultations",
      ],
      logo: "🏥",
      rating: 5,
      testimonial:
        "They helped us build credibility in a sensitive industry. Their understanding of healthcare marketing is exceptional.",
    ...
    },
    {
      ...
      results: [
        "800% growth in course enrollments",
        "90% completion rates",
        "150% increase in revenue per user",
      ],
      logo: "🎓",
      rating: 5,
      testimonial:
        "Instantlly made us a household name in online education. Their innovative approach set us apart from competitors.",
      author: "Anita Desai",
            ...
            return (
              <div
                ...
                style={{
                  ...
                  transition:
                    "all 1000ms cubic-bezier(0.4, 0, 0.2, 1), filter 800ms ease-in-out",
                }}
              >
                <Card
                  className={`w-80 lg:w-96 h-80 lg:h-96 glass border-white/10 transition-all duration-800 cursor-pointer group ${
                    isCenter
                  ...
                  <CardContent className="p-8 h-full flex flex-col justify-between">
                    <div>
                      ...
                      {isCenter ? (
                        <div className="space-y-4">
                          <div className="flex items-center mb-3">
                            {[...Array(study.rating)].map((_, i) => (
                              <Star
                                key={i}
                                className="h-4 w-4 text-neon-orange fill-current"
                              />
                            ))}
                          </div>
                        ...
                        <div className="space-y-4">
                          <div>
                            <h4 className="font-semibold text-neon-orange mb-2 text-sm">
                              Challenge
                            </h4>
                          ...
                          <div>
                            <h4 className="font-semibold text-neon-blue mb-2 text-sm">
                              Results
                            </h4>
                            <ul className="space-y-1">
                              {study.results.slice(0, 2).map((result, i) => (
                                <li
                                  key={i}
                                  className="flex items-center text-foreground/80 text-xs"
                                >

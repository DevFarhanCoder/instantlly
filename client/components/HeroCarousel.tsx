...
const HeroCarousel = () => {
  ...
  const slides: SlideData[] = [
    {
      ...
      description:
        "Transform your brand with cutting-edge marketing strategies that drive real results. Online and offline solutions that convert everywhere.",
      stats: [
    ...
    },
    {
      ...
      description:
        "Instant marketing + pan-India distribution. From brand creation to market domination, we scale your business nationwide.",
      stats: [
    ...
    },
    {
      ...
      description:
        "Complete brand transformation from concept to market leadership. We don't just promote your brand—we architect its entire journey to success.",
      stats: [
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
      ...
      <div
        className="absolute bottom-1/4 right-1/4 w-40 md:w-80 h-40 md:h-80 bg-neon-orange/20 rounded-full blur-3xl animate-float"
        ...
        <div className="max-w-5xl mx-auto">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-12 px-4">
              <Button
                size="lg"
                className="w-full sm:w-auto bg-gradient-to-r from-neon-blue to-neon-orange hover:shadow-lg hover:shadow-primary/25 transition-all duration-300 group px-6 md:px-8 py-3 md:py-4 text-base md:text-lg"
              >
                {currentSlide === 1
              ...
              <Button
                size="lg"
                variant="outline"
                className="w-full sm:w-auto border-primary/50 bg-black text-white hover:bg-primary/10 px-6 md:px-8 py-3 md:py-4 text-base md:text-lg group"
              >

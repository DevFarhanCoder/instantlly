        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-foreground/80 mb-6 leading-relaxed">
              Who We Sell, We Grow Your Brand. Your trusted partner for
              marketing, branding & pan-India distribution.
            </p>
            <div className="flex space-x-4">
              <a
                href="#"
                className="w-10 h-10 rounded-lg glass border-white/10 flex items-center justify-center hover:border-primary/50 transition-colors"
              >
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start space-x-3">
                ...
                <a
                  href="mailto:hello@instantlly.com"
                  className="text-foreground/80 hover:text-primary transition-colors"
                >

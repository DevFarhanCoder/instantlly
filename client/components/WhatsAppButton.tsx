...
const WhatsAppButton = () => {
  const handleWhatsAppClick = () => {
    ...
    const phoneNumber = "919820540202"; // Example: +91 98765 43210 becomes 919876543210
  ...
  return (
    <button
      ...
      className="fixed bottom-6 right-6 z-50 w-14 h-14 bg-green-500 hover:bg-green-600 text-white rounded-full shadow-2xl hover:shadow-green-500/25 transition-all duration-300 flex items-center justify-center group"

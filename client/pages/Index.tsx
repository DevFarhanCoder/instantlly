    ...
    <div className="bg-background overflow-hidden">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <AnimatedSection>
              ...
              <p className="text-lg md:text-xl text-foreground/80 mb-6 leading-relaxed">
                Founded with a vision to revolutionize digital marketing in
                India, Instantlly has emerged as a leading marketing agency that
                combines creativity with data-driven strategies.
              </p>
              <p className="text-base md:text-lg text-foreground/70 mb-8 leading-relaxed">
                We specialize in creating instant impact for brands through
                innovative campaigns, cutting-edge technology, and deep market
                insights. Our team of experts works tirelessly to deliver
            ...
            <AnimatedSection delay={300}>
              <div className="relative">
                <div className="glass rounded-3xl p-8 border border-white/10">
                  <div className="grid grid-cols-2 gap-6">
                    <div className="text-center">
                      ...
                      <h3 className="font-bold text-gradient mb-2">
                        Innovation
                      </h3>
                    ...
                    <div className="text-center">
                      ...
                      <p className="text-sm text-foreground/70">
                        Data-driven strategies that hit the mark
                      </p>
                    </div>
                    <div className="text-center">
                      <div className="w-16 h-16 bg-gradient-to-r from-neon-blue/20 to-neon-blue/40 rounded-2xl flex items-center justify-center mb-4 mx-auto">
                    ...
                    <div className="text-center">
                      ...
                      <p className="text-sm text-foreground/70">
                        Award-winning campaigns and results
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div
                  className="absolute -bottom-4 -left-4 w-16 h-16 bg-neon-orange/20 rounded-full blur-2xl animate-float"
        ...
        <div className="container mx-auto px-4 md:px-6">
          <AnimatedSection className="text-center mb-12">
            ...
            <p className="text-lg md:text-xl text-foreground/80 max-w-2xl mx-auto">
              Our track record speaks for itself. Here's why brands choose us
              again and again.
            </p>
          </AnimatedSection>
      ...
      >
        <div className="container mx-auto px-4 md:px-6">
          <AnimatedSection className="text-center mb-12 md:mb-16">
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-4 md:mb-6 text-gradient">
              Our Services
            </h2>
            <p className="text-lg md:text-xl text-foreground/80 max-w-2xl mx-auto px-4">
              From strategy to execution, we provide comprehensive marketing
            ...
            {[
              {
                ...
                description:
                  "Create memorable brands that resonate with your audience and stand out in the marketplace.",
                color: "neon-blue",
              },
              {
                icon: Code,
                ...
                description:
                  "Build fast, responsive websites optimized for conversions and user experience.",
                color: "neon-orange",
              },
              {
                icon: BarChart,
                ...
                description:
                  "Data-driven campaigns across all channels to maximize your reach and ROI.",
                color: "neon-blue",
              },
              {
                icon: Target,
                ...
                description:
                  "Strategic guidance to align your marketing efforts with business objectives.",
                color: "neon-orange",
              },
              {
                icon: Zap,
                ...
                description:
                  "Continuously improve and optimize your marketing performance for better results.",
                color: "neon-blue",
              },
              {
                icon: Globe,
                ...
                description:
                  "Scale your brand internationally with localized marketing strategies.",
                color: "neon-orange",
              },
            ].map((service, index) => (
              <AnimatedSection key={index} delay={index * 100}>
                <Card className="glass border-white/10 hover:border-primary/50 transition-all duration-300 group cursor-pointer h-full">
                  <CardContent className="p-6 md:p-8">
                    <div
                      className={`w-12 h-12 md:w-16 md:h-16 rounded-2xl bg-gradient-to-r ${
                        service.color === "neon-blue"
                          ? "from-neon-blue/20 to-neon-blue/40"
                          : "from-neon-orange/20 to-neon-orange/40"
                    ...
                    <h3 className="text-lg md:text-xl font-bold mb-3 md:mb-4 group-hover:text-gradient transition-all duration-300">
                      {service.title}
                    </h3>
      ...
      <section className="py-16 md:py-24 bg-background">
        <div className="container mx-auto px-4 md:px-6">
          <AnimatedSection className="text-center mb-12 md:mb-16">
            ...
            <p className="text-lg md:text-xl text-foreground/80 max-w-2xl mx-auto">
              Our proven 4-step process ensures every project delivers
              exceptional results from strategy to execution.
            </p>
          </AnimatedSection>
            ...
            {[
              {
                ...
                description:
                  "We deep-dive into your business, market, and goals to create a comprehensive strategy.",
                icon: Lightbulb,
                color: "neon-blue",
              },
              {
                ...
                description:
                  "Our creative team brings your brand to life with compelling visuals and messaging.",
                icon: Palette,
                color: "neon-orange",
              },
              {
                ...
                description:
                  "We launch multi-channel campaigns with precision timing and flawless execution.",
                icon: Rocket,
                color: "neon-blue",
              },
              {
                ...
                description:
                  "Continuous monitoring and optimization to maximize performance and ROI.",
                icon: TrendingUp,
                color: "neon-orange",
              },
            ].map((process, index) => (
              <AnimatedSection key={index} delay={index * 150}>
                <div className="relative text-center">
                  <div className="glass border-white/10 rounded-2xl p-6 hover:border-primary/50 transition-all duration-300 group">
                    <div className="absolute -top-4 left-1/2 transform -translate-x-1/2">
                      <div
                        className={`w-8 h-8 rounded-full bg-gradient-to-r ${
                          process.color === "neon-blue"
                            ? "from-neon-blue to-neon-blue"
                            : "from-neon-orange to-neon-orange"
                    ...
                    <h3 className="text-lg md:text-xl font-bold mb-4 group-hover:text-gradient transition-all duration-300">
                      {process.title}
                    </h3>
                    <p className="text-sm md:text-base text-foreground/70 leading-relaxed">
                      {process.description}
      ...
      <section id="success-stories" className="py-16 md:py-24 bg-background">
        <div className="container mx-auto px-4 md:px-6">
          <AnimatedSection className="text-center mb-12 md:mb-16">
            ...
            <p className="text-lg md:text-xl text-foreground/80 max-w-2xl mx-auto px-4">
              See how we've helped brands achieve remarkable growth and exceed
        ...
        <div className="container mx-auto px-4 md:px-6">
          <AnimatedSection className="text-center mb-12 md:mb-16">
            ...
            <p className="text-lg md:text-xl text-foreground/80 max-w-3xl mx-auto px-4">
              From Mumbai to Delhi, Bangalore to Kolkata, we've established a
              strong footprint across India, serving clients nationwide with
              localized expertise and global standards.
            </p>
          </AnimatedSection>
            ...
            {[
              ...
              <AnimatedSection key={index} delay={index * 100}>
                <div className="text-center glass border-white/10 rounded-2xl p-6 hover:border-primary/50 transition-all duration-300">
                  ...
                  <h3 className="text-lg md:text-xl font-bold text-gradient mb-2">
                    {location.city}
                  </h3>
        ...
        <div className="container mx-auto px-4 md:px-6">
          <AnimatedSection className="text-center mb-12 md:mb-16">
            ...
            <p className="text-lg md:text-xl text-foreground/80 max-w-3xl mx-auto">
              ...
              diverse industries achieve their marketing goals with tailored
              strategies.
            </p>
          </AnimatedSection>
            ...
            {[
              {
                name: "Technology",
                icon: Code,
                description: "SaaS, Apps, Software",
              },
              {
                name: "E-commerce",
                icon: ShoppingBag,
              ...
              },
              {
                name: "Automotive",
                icon: Car,
                description: "Cars, Motors, Parts",
              },
              {
                name: "Manufacturing",
                icon: Building,
                description: "Industrial, B2B, Supply",
              },
            ].map((industry, index) => (
              <AnimatedSection key={index} delay={index * 100}>
                <Card className="glass border-white/10 hover:border-primary/50 transition-all duration-300 group cursor-pointer h-full">
          ...
          <AnimatedSection className="text-center">
            <div className="glass border-white/10 rounded-3xl p-8 max-w-2xl mx-auto">
              ...
              <p className="text-foreground/80 mb-6 leading-relaxed">
                We work with businesses across all sectors. Let's discuss how we
                can help your specific industry.
              </p>
            ...
            {[
              {
                ...
                content:
                  "Working with this agency transformed our digital presence. Their strategic approach and execution excellence delivered results beyond our expectations.",
                avatar: "👩🏻‍💼",
                rating: 5,
              },
              {
                ...
                content:
                  "The team's creativity and data-driven approach helped us achieve a 300% increase in qualified leads. Absolutely exceptional work.",
                avatar: "👨🏽‍💼",
                rating: 5,
              },
              {
                ...
                content:
                  "From brand strategy to campaign execution, they delivered at every touchpoint. Our revenue grew 250% in just 6 months.",
                avatar: "👩🏼‍💼",
                rating: 5,
              },
                ...
                <Card className="glass border-white/10 p-6 hover:border-primary/50 transition-all duration-300 h-full">
                  <div className="flex items-center mb-4">
                    {[...Array(testimonial.rating)].map((_, i) => (
                      <Star
                        key={i}
                        className="h-4 w-4 md:h-5 md:w-5 text-neon-orange fill-current"
                      />
                    ))}
                  </div>
                  <p className="text-foreground/80 mb-6 leading-relaxed italic text-sm md:text-base">
                    "{testimonial.content}"
                  </p>
                  <div className="flex items-center">
                    ...
                    <div>
                      <h4 className="font-semibold text-gradient text-sm md:text-base">
                        {testimonial.name}
                      </h4>
      ...
      <section className="py-16 md:py-24 bg-gradient-to-b from-background to-muted/50">
        <div className="container mx-auto px-4 md:px-6">
          <AnimatedSection className="text-center mb-12 md:mb-16">
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-4 md:mb-6 text-gradient">
              Why Choose Instantlly?
            </h2>
            <p className="text-lg md:text-xl text-foreground/80 max-w-2xl mx-auto">
              We don't just create campaigns—we build partnerships that drive
            ...
            {[
              {
                ...
                description:
                  "Every decision backed by comprehensive analytics and market research for maximum impact.",
                icon: BarChart,
                color: "neon-blue",
              },
              {
                ...
                description:
                  "Award-winning creative team that brings fresh perspectives to every campaign.",
                icon: Award,
                color: "neon-orange",
              },
              {
                ...
                description:
                  "Quick turnaround times and 24/7 support to keep your campaigns running smoothly.",
                icon: Zap,
                color: "neon-blue",
              },
              {
                ...
                description:
                  "500+ successful campaigns with measurable results across diverse industries.",
                icon: TrendingUp,
                color: "neon-orange",
              },
              {
                ...
                description:
                  "Dedicated account managers who understand your business inside and out.",
                icon: Users,
                color: "neon-blue",
              },
              {
                title: "24/7 Support",
                description:
                  "Round-the-clock assistance to ensure your marketing never sleeps.",
                icon: Headphones,
                color: "neon-orange",
              },
            ].map((reason, index) => (
      ...
      >
        ...
        <div
          className="absolute bottom-1/4 right-1/4 w-40 h-40 bg-neon-orange/20 rounded-full blur-3xl animate-float"
